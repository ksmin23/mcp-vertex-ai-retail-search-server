# Vertex AI Search for Retail MCP Server

This project is a Model Context Protocol (MCP) server example that provides the [Vertex AI Search for Retail](https://cloud.google.com/retail) API from Google Cloud as a tool, using [FastMCP](https://github.com/fastmcp/fastmcp-py).
...
-   Provides Vertex AI Search for Retail product search functionality (`search_products`)
